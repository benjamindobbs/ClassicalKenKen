// Vendored copy of ../../js/auth.js — the it. subdomain's host-rewrite in server/index.js
// serves this folder as its own root, so a relative "../js/auth.js" would 404. Keep in sync
// with the root copy if the login/session flow changes.
